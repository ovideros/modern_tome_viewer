...
t("A Fist Full of Demons", "恶魔杀戮者", "achievement name")
t("Killed 1000 demons.", "杀死1000个恶魔。", "_t")
t("Glory to the Fearscape", "恐惧长廊之荣耀", "achievement name")
t("Activated all 23 different kinds of demon statues.", "启动全部23个不同的恶魔雕像", "_t")
...
t("#LIGHT_GREEN#Kryl-Feijan#LAST#", "#LIGHT_GREEN#卡洛·斐济#LAST#", "_t")
t("Kryl-Feijan", "卡洛·斐济", "_t")
t("#LIGHT_GREEN#Walrog#LAST#", "#LIGHT_GREEN#乌尔罗格#LAST#", "_t")
t("Walrog", "乌尔罗格", "_t")
...
t("Doomelf", "魔化精灵", "birth descriptor name")
...
and then you may witness a new elf's conception...]], [[玛·洛克的恶魔绝不会对你施以祝福！ 
三者可以诉说精灵所带来的恐怖
之一在无尽的深海中永远咆哮
之一召集邪徒为复活另一者而战
静默他们的声音，隐藏你的踪影
...
t("Demonic Tatoos 1", "恶魔纹身1", "_t")
t("Demonic Tatoos 2", "恶魔纹身2", "_t")
t("Demonic Tatoos 3", "恶魔纹身3", "_t")
t("Demonic Tatoos 4", "恶魔纹身4", "_t")
t("Demonic Tatoos 5", "恶魔纹身5", "_t")
t("Demonic Tatoos 6", "恶魔纹身6", "_t")
t("Demonic Tatoos 7", "恶魔纹身7", "_t")
t("Demonic Tatoos 8", "恶魔纹身8", "_t")
...
t("fire haven", "火焰避难所", "_t")

------------------------------------------------
section "tome-ashes-urhrok/data/general/grids/demon_statues.lua"

t("Rogroth, Eater of Souls", "罗格洛斯，灵魂吞噬者", "_t")
t("a champion of Urh'Rok", "一位乌鲁洛克的精英卫兵", "_t")
t("the Corrupted Daelach", "堕落达莱奇", "_t")
t("a daelach", "一只达莱奇", "_t")
t("a dolleg", "一只多雷格", "_t")
t("Draebor, the Imp", "小恶魔德瑞宝", "_t")
t("a dúathedlen", "一只多瑟顿", "_t")
t("a fire imp", "一只火魔婴", "_t")
t("a forge giant", "一只锻造巨人", "_t")
t("Khulmanar, General of Urh'Rok", "库马纳·乌鲁洛克之近卫将军", "_t")
t("Kryl-Feijan", "卡洛·斐济", "_t")
t("Lithfengel", "里斯丰格", "_t")
t("an onilug", "一只欧尼路格", "_t")
t("a quasit", "一只夸塞魔", "_t")
t("Shasshhiy'Kaish", "莎西·凯希", "_t")
t("a thaurhereg", "一只修尔希瑞格", "_t")
t("an uruivellas", "一只乌尔维拉斯", "_t")
t("Walrog", "乌尔罗格", "_t")
t("a water imp", "一只小水怪", "_t")
t("a wretchling", "一只酸液树魔", "_t")
t("a wretch titan", "一只腐化泰坦", "_t")
t("a ruin banshee", "一只毁灭女妖", "_t")
t("Harkor'Zun", "哈卡祖", "_t")
t("floor", "地板", "entity type")
t("lava", "岩浆", "entity subtype")
t("statue of %s", "%s的雕像", "tformat")
t("Demon Statue of %s", "%s的恶魔雕像", "tformat")
...
t("demon", "恶魔", "entity type")
t("major", "大恶魔", "entity subtype")
t("wretch titan", "腐化泰坦", "entity name")
t("Many an adventurer has encounted the wretchling. Terrible things, wretchlings. Swarming, gnashing, burning. What those adventurers don't know is that those are just the children.", "许多冒险家都遭遇过酸液树魔。相当可怕，酸液树魔们，成群出现，灼烧腐蚀。但这些冒险家们不知道，酸液树魔只是它的未成熟的孩子。", "_t")
...
t("These massive gauntlets once belonged to a very powerful demon named Ul'Gruth. The behemoth was said to be able to level entire buildings with a single swing of his hands.", "这双巨大的手套曾经属于一个名叫乌尔格鲁斯的强大的恶魔。据说，这个怪物一挥手就能将一座城市夷为平地。", "_t")
t("Your Obliterating Smash can destroy walls.", "你的歼灭挥斩能摧毁墙壁", "_t")
t("Fearfire Mantle", "恐惧之焰", "entity name")
t("cloak shaped flames", "火焰般的斗篷", "_t")
...
t("The joints of this armor creak ominously, the frame bends and heaves, almost as if breathing. The scratch and crack of metal mutters of suffering, of loss, perseverance and revenge.", "关节不祥的咯吱作响，骨架弯曲突起的呼吸。划痕与裂纹是金属的低语，有关苦楚、失去、坚持与复仇。", "_t")
...
This band of gothic obsidian menaces with an embossed image of a grinning skull. It beckons you to tempt fate and put it on. Do you?]], [[这不是我想要的结果！- 豪瓦尔·穆朗斯，科纳克人恶魔使者。
狞笑着的骷髅图案在这个由黑曜石铸成的哥特式戒指上隐约浮现。骷髅似乎在召唤着你，使你情不自禁想要铤而走险地把它戴在手上，转动命运之轮。你会这么做吗？]], "_t")
t("strange black ring", "奇怪的黑色戒指", "_t")
t("#RED#The ring refuses to be removed!", "#RED#戒指拒绝被卸下！", "logPlayer")
t("Cannot be unequipped or rerolled until level %d.", "在达到等级%d之前，不能解除装备和重置。", "tformat")
t("Can be unequipped, can't be rerolled.", "能解除装备，不能重置", "_t")
t("Can be unequipped or rerolled.", "能解除装备或重置", "_t")
t("re-generate the item with random stats. Can only be done three levels after the last reroll. Cannot be unequipped unless a reroll is available, or you are level 50", "重置戒指属性。每3级能重置一次。除非有重置机会或者人物50级，否则不能解除装备。", "_t")
t("#RED#The ring does not react.", "#RED#戒指没有反应。", "logPlayer")
t("#CRIMSON#Your timetravel has no effect on pre-determined outcomes such as this.", "#CRIMSON#你的时间穿越对这种已经预设好的结局没有任何作用。", "_t")
t("Wheel of Fate", "命运之轮", "_t")
...
t("\"Lock your soul away, and death will never reach you.\"", "锁住灵魂，死亡莫及。", "_t")
t("Grants spellpower equal to your Shadow Power.", "每点“阴影强度”增加1点法术强度", "_t")
t("The Black Spike", "黑之钉", "entity name")
t("thin black sword", "很薄的黑色短剑", "_t")
t("\"All the better to pierce the heart of the world.\"", "世界之心，终将刺穿", "_t")
...
t("massive obsidian shield", "巨大的黑曜石盾牌", "_t")
t("\"With this, no one will ever harm you again.\"", "披坚持盾，众莫能伤", "_t")
t("Increases all resists by 0.4% for each point of your Shadow Power.", "每点“阴影强度”增加0.4%全体抗性", "_t")
t("Planar Beacon", "空间信标", "entity name")
t("glowing red orb", "闪光的红色球体", "_t")
t("A strange orb of demonic origins. It glows with a surreal red light.", "从恶魔手里拿到的奇怪的球体，它正闪耀着超现实的红光。", "_t")
...
t("history of Mal'Rok (mistranslated)", "有关玛·洛克历史的模糊印象", "_t")
...
]], [[他们乘着巨大的飞行堡垒前来，上面装满了各种武器，即使在远处也可以感受到它放射出来的强大魔法力量。他们没有直接威胁我们，但是他们和我们的领袖会面，像我们提出了一个交易——同时也是一个最后通牒：他们将动手杀掉父亲，或者选择我们自己动手干掉他，这样他们将会赠予给我们他们所有用的科技和魔法。
...
t("orbital base: battle info with #{bold}#a badass#{normal}#", "轨道基地: 有关一个#{bold}#碉堡的人#的战斗情报{normal}#", "_t")
...
#{bold}#WE SEE YOU.#{normal}#]], [[#{italic}#上面的文字被浮动的阴影所笼罩，你只能依稀看到模糊的文字碎片#{normal}#
...
t("demon statue: Kryl-Feijan", "恶魔雕像:卡洛·斐济", "_t")
...
t("demon statue: Khulmanar, General of Urh'Rok", "恶魔雕像:库马纳·鲁洛克之近卫将军", "_t")
...
t("#SLATE#* You have to destroy the Planar Controller to escape.#WHITE#", "#SLATE#* 想要逃跑，你必须摧毁空间控制者。#WHITE#", "_t")
t("#SLATE#* You have to destroy the controlling crystal before leaving or the demons will be able to track you down.#WHITE#", "#SLATE#* 你必须在逃跑前摧毁控制水晶，否则恶魔能利用那个东西追踪你。#WHITE#", "_t")
...
t("Hits the target doing %d%% weapon damage. This attack cannot miss, and ignores all armor and resistances on the target. However, you take damage equal to %d%% of the damage dealt, or 30%% of your current HP, whichever is lower.", [[攻击目标，造成 %d%% 武器伤害。本次攻击必中，且无视目标护甲和抗性。
	但是，你自己会受到输出伤害的 %d%% 或者当前生命值 30%% 的伤害，取数值较低者。]], "tformat")
t("Share the Pain", "以眼还眼", "talent name")
t([[You revel in the heat of battle. Whenever an enemy damages you within melee range, you have a %d%% chance to counter with an attack for %d%% weapon damage.
		You get once chance to deal this damage to a particular target each turn.]], [[你沉迷于战争的狂热。当一个近身的敌对生物伤害你时，有 %d%% 几率自动反击，造成 %d%% 武器伤害。
	此效果每回合对同一目标触发一次。]], "tformat")
...
t("doom covenant", "末日降临", "talent type")
t("Control darkness to crush your foes.", "使用黑暗之力击溃敌人。", "_t")
t("spellblaze", "魔法大爆炸", "talent type")
t("Use the very power of the Spellblaze to destroy your foes.", "调用魔法大爆炸的特殊力量摧毁敌人。", "_t")
t("brutality", "残暴", "talent type")
t("Devastating two-handed physical attacks fueled by demonic power.", "用恶魔之力驱使双手武器，施展毁灭性的打击。", "_t")
t("torture", "折磨", "talent type")
t("Cripple your enemies with vicious two-handed attacks.", "用恶毒的双手攻击让敌人残废。", "_t")
t("wrath", "愤怒", "talent type")
t("Destroy your enemies with intense two-handed physical attacks fueled by demonic power.", "用恶魔之力驱使双手武器，毁灭你的敌人。", "_t")
t("Fearfire", "恐惧之炎", "talent type")
t("Call upon the flames of the Fearscape, incinerating all.", "召唤恶魔空间的火炎，燃尽一切。", "_t")
t("Heart of Fire", "狱火之核", "talent type")
t("Fire is your lifeblood; it revitalizes you as it burns your foes.", "火是你的生命之源，它给予你力量，同时灼烧敌人。", "_t")
t("demonic strength", "恶魔之力", "talent type")
t("Infuse your body with the power of Demons.", "使用恶魔之力强化自身。", "_t")
t("Oppression", "压制", "talent type")
t("Make your blows terrify your foes and manipulate their fear.", "你的攻击令敌人闻风丧胆。", "_t")
t("Demon", "恶魔", "_t")
...
t([[Randomly (%d%% chance) hurls up to %d flame bolts dealing %0.2f fire damage to foes in sight when you hit in melee.
		The damage will increase with your Spellpower.]], [[当你近战攻击命中时，有 %d%% 几率释放至多 %d 个火球，造成 %0.2f 点火焰伤害。
		伤害受法术强度加成。]], "tformat")
...
t("Farstrike", "远程打击", "talent name")
t("You send your weapon flying to the target, dealing %d%% weapon damage.", "扔出武器攻击远处敌人，造成 %d%% 武器伤害。", "tformat")
t("Corrosive Slashes", "腐蚀鞭笞", "talent name")
t([[You cover your weapon in acid, turning all melee damage into acid.
		All melee attacks also gain %d armor penetration.]], [[用酸液覆盖武器，近战伤害转变为酸性。
		近战攻击获得 %d 护甲穿透。]], "tformat")
t("Acidic Bath", "酸浴", "talent name")
...
t([[Each time you walk or move you gain a blight charge. You can store up to %d charges.
		...
		伤害受法术强度加成。]], "tformat", {1,2,4,3,5})
t("Corrupt Light", "腐化之光", "talent name")
t([[Weave darkness in a radius of %d. All unlit grids contribute to your power by increasing all your damage done for %d turns.
		Damage increase depends on the number of grids extinguished.]], [[在半径 %d 范围内扩散黑暗。每一块黑暗的地形，都在接下来的 %d 回合里增加你的伤害。
		伤害增加效果受熄灭的地格数量加成。]], "tformat")
t("Shadowmeld", "暗影融合", "talent name")
...
t([[When you deal a critical strike in melee, you send out a cone of acid, dealing %d damage to all enemies and melting walls you hit.
		The damage will increase with your Spellpower.]], [[每次近战暴击时，将释放一股锥形酸液，造成 %d 伤害并融化墙壁。
		伤害受法术强度加成。]], "tformat")
...
t("@Source@ breathes fetid matter!", "@Source@吐出恶臭的物质！", "_t")
t([[You breathe a mix of darkness and flight in a frontal cone of radius %d. Any target caught in the area will take %0.2f darkness/blight damage.
		...
		]], [[你朝前方 %d 码锥形区域吐出一团黑暗的疫气。所有被击中的目标会受到 %0.2f 暗影/枯萎伤害。
		此外，你进行近战攻击的时候有 10%% 几率免费触发一次吐息。
		伤害受法术强度加成。
		]], "tformat")
...
t([[Using demonic forces you jump high in the sky and fall down on your target as a meteor, slamming the ground with your shield.
		The impact is so powerful it shakes the ground in radius %d, dealing a %d%% fire and physical shield attack to all foes and turning the ground into lava.]], [[你使用恶魔的力量跳上天空，然后落下，如流星一般使用盾牌重击敌人。
		这一打击无比强大，震撼 %d 码范围的地面，对所有敌人造成 %d%% 火焰物理盾牌伤害，并将地面变成岩浆。]], "tformat")
t("Blazing Phase", "烈焰突袭", "talent name")
...
t([[For every turn where you take damage you have a %d%% chance to store a seismic charge.
		...
		The damage increases with your spellpower.]], [[每个你受到伤害的回合，你有 %d%% 存储一次地震能量。
		你可以主动使用这一技能，释放地震充能，召唤出一个火山，每层充能持续 2 回合。
...
t([[Strike a blow with your weapon for %d%% blight damage.
		...
		高技能等级将带来更强大的种子。
		如果成功将种子植入稀有恶魔的体内，且它有对应的恶魔种子的话，你将会必定获得对应的恶魔种子。]], "tformat")
...
t("You require a weapon and a shield to use this talent.", "你需要一把武器一个盾牌来施展这个技能。", "logPlayer")
t("#SLATE#(%d turned into osmosis)#LAST#", "#SLATE#(%d到渗透护盾)#LAST#", "tformat")
...
t("Maw of Urh'rok", "乌鲁洛克之胃", "talent name")
...
t([[You unleash the fury of the Spellblaze, constantly draining your vim.
		...
		This spell disabled automatically on rest or run.
		The effects increase with spellpower.]], [[你释放魔法大爆炸的力量，持续消耗活力。
		当技能开启时，每回合将召唤 2 个陨石坠落在你身边，在半径 2 的范围内造成 %0.2f 物理与 %0.2f 火焰伤害。
		这项法术在休息或跑步时自动关闭。
		效果受法术强度加成。]], "tformat")
t("Only Ashes Left", "唯余灰烬", "talent name")
...
t([[The tortures you had to endure on the Fearscape have increased your resilience.
		...
		所有负面状态持续时间减少 %d%% , 同时你能摆脱 %d%% 暴击伤害。]], "tformat")
...
t("Next melee attack will always trigger incinerating blows, and the damage from incinerating blows will be multiplied by %d%%", "接下来一次近战攻击必定触发焚尽强击，且焚尽强击伤害增加 %d%%", "tformat")
...
t("Improves/gives invisibility (power %d), converts all damage to darkness and uses your highest damage penetration and increase for darkness.", "获得隐形（强度 %d）所有伤害转化为暗影伤害，暗影伤害使用你最高的伤害加成和抗性穿透。", "tformat")
...
t("portal to the main island", "通向主岛的传送门", "entity name")
...
t("demonic spike", "恶魔尖刺", "entity name")

------------------------------------------------
section "tome-ashes-urhrok/data/zones/anteroom-agony/npcs.lua"

t("enthralled %s", "被奴役的 %s", "tformat")
...
t("major", "大恶魔", "entity subtype")
t("Fire and blight arcane surges randomly appear on this spider-like dark metallic skin. There are no definite head but a single huge mouth onto its body.", "火焰和枯萎的力量在蜘蛛一样的黑色金属皮肤上闪现。它没有明显的头部，只有一个大大的嘴巴。", "_t")
...
t("demon killed by a meteor", "被流星砸死的恶魔", "entity name")
t("impact crater", "陨石坑", "entity name")
t("tracking control crystal", "追踪控制晶体", "entity name")
t("destroying the crystal", "摧毁水晶中", "_t")
t("destroyed the crystal", "摧毁了水晶", "_t")
t("#VIOLET#The crystal is destroyed!", "#VIOLET#水晶被摧毁了！", "log")
t("#YELLOW#The disturbance has attracted the Planar Controller!", "#YELLOW#你制造的混乱引来了空间控制者！", "say")
t("floor", "地板", "entity subtype")
...
t("Class: Demonologist", "职业：恶魔使者", "_t")
t("Cosmetic: demonic horns", "外观：恶魔的角", "_t")
t("Cosmetic: red skin", "外观：红色皮肤", "_t")
...
t("Welcome to #CRIMSON#Ashes of Urh'Rok", "欢迎来到#CRIMSON#乌鲁洛克之烬", "_t")
