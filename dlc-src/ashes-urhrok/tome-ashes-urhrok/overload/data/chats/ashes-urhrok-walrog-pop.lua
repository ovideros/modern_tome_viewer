...
local popup = function(npc, player)
	npc:doEmote(_t"Vengeance for...  companions...", 90, colors.BLUE)
end

newChat{ id="welcome",
	text = ([[As the %s falls dead, bubbles start forming beneath you, then frothing as the water grows uncomfortably warm.
...
#AQUAMARINE#"How convenient...  so much Sher'Tul magic for my taking...  magic to turn against its creators...  but now... one new obstacle...  one last great warrior under the waves..."#WHITE#]]):tformat(kind),
	answers = {
		{_t"The oceans are yours.  The people of Eyal gave up sea travel ages ago!", jump="a"},
		{_t"You're the new Lord of the Seas?  What would you have me do?", jump="b"},
		{_t"The seas of Eyal shall know no lord, foul demon!  The chaos and death ends now!", jump="c"},
		{_t"Stop bubbling and start dying, you overgrown tea-kettle!  Your treasures are mine!", action=popup},
	}
}

newChat{ id="a",
	text = _t[[The frothing form frowns.
...
#AQUAMARINE#"No reason to wait..."#WHITE#]],
	answers = {
		{_t"#LIGHT_GREEN#[fight]#WHITE#", action=popup},
	}
}
...
The frothing and bubbling around him grows to new heights as he charges you!]]):tformat((kind == "naga" and _t"Traitor" or _t"Murderer")),
	answers = {
		{_t"#LIGHT_GREEN#[fight]#WHITE#", action=popup},
	}
}
...
newChat{ id="c",
	text = _t[[He chuckles, bubbles bursting from his mouth with every laugh.
