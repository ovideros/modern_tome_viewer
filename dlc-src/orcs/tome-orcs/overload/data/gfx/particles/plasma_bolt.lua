...
return { generator = function()
	...
	--the colors are in hsl
	--the hue is rotated 180 degrees so that the average moves through red for appearance
	
	local clight = {45 + 180, 1, 0.7}
	...
	return {
		...
		vel = sradius / 1.5 / 6, velv = 0, vela = -sradius / 6 / 36,

		r = r,  		rv = 3/255, ra = 0,
		g = g,  		gv = 3/255, ga = 0,
		b = b, 		bv = 3/255, ba = 0,
		a = rng.range(150, 255)/255 * density, 		av = 0, aa = 0,
	}
end, },
function(self)
	self.ps:emit(24)
