...
return { generator = function()
	...
	local kind = rng.percent(70)
	local bc = rng.float(0.10, 0.20)
	...
	return {
		...
		r = kind and rng.float(0.4, 0.7) or bc/2,   rv = 0, ra = 0,
		g = kind and rng.float(0.2, 0.4) or bc,   gv = 0, ga = 0,
		b = kind and rng.float(0.2, 0.4) or bc,      bv = 0, ba = 0,
		a = kind and rng.float(0.2, 0.8) or bc,    av = 0, aa = 0,
	}
end, },
function(self)
	self.ps:emit(8)
