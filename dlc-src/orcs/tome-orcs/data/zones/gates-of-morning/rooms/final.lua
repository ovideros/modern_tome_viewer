...
return function(gen, id)
	...
	return { name="final"..room.w.."x"..room.h, w=room.w, h=room.h, generator = function(self, x, y, is_lit)
		...
		for _, spot in ipairs(room.spots[2]) do
			local e = gen.zone:makeEntity(gen.level, "actor", {special=function(e) return e.faction == "sunwall" end}, nil, true)
			if e then
				gen:roomMapAddEntity(x + spot.x, y + spot.y, "actor", e)
				e.on_added_to_level = nil
			end
