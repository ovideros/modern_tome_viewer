...
newLore{
	...
	name = _t"a warning sign",
	lore = _t[[WARNING - READ THIS!
...
newLore{
	id = "primal-forest-2",
	category = "primal forest",
	name = _t"a pamphlet 'Eyal Needs You!'",
	lore = _t[[EYAL NEEDS YOU!
...
newLore{
	id = "primal-forest-3",
	category = "primal forest",
	name = _t"'On Tolerance'",
	lore = _t[[We recognize that times are changing.  Within a year, the Allied Kingdoms have gone from begrudgingly tolerating magic to openly embracing it, due to the influence of our rediscovered allies in the East.  Furthermore, if the reports are to be believed, the ecosystem of Var'Eyal remains healthy and intact, despite millennia of continuous magic-use.  Therefore, our views and approach must change with the times; we are not ignorant to new knowledge.
...
newLore{
	id = "primal-forest-4",
	category = "primal forest",
	name = _t"a leaf-bound journal",
	lore = _t[[[i](You see here a leaf-bound journal; the moment you open it, it begins to wither and crumble.  You manage to rip out one page; it is still disintegrating, but slowly enough that you can read it before it turns to dust.)[/i]
