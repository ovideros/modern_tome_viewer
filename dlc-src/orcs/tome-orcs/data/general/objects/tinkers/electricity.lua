...
local metals = {_t"iron", _t"steel", _t"dwarven steel", _t"stralite", _t"voratun"}

-- On crit, no proc limit
for i = 1, 5 do
newEntity{ base = "BASE_TINKER", define_as = "TINKER_LIGHTNING_COIL"..i,
	name = ("%s lightning coil"):tformat(simple[i]), image = "object/tinkers_lightning_coil_t5.png",
	on_type = "weapon",
	material_level = i,
	metallic = true,
	special_desc = function(self) return _t"On critical strikes generates a 3 tiles lightning beam." end,
	on_tinker = function(self, o, who)
		if not o.combat then return true end
		o.combat.lightning_coil_ml = self.material_level
		o:orcsWeaponAddOnEffect("special_on_crit", "lightning_coil", {desc=_t"project a beam of lightning", fct=function(combat, who, target)
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_MANA_COIL"..i,
	name = ("%s mana coil"):tformat(simple[i]), image = "object/tinkers_mana_coil_t5.png",
	on_type = "weapon", on_subtype = "staff",
	material_level = i,
	metallic = true,
	special_desc = function(self) return _t"Mana regeneration, on spell hit 25%% chances to cast lightning." end,
	object_tinker = {
		wielder = {
			mana_regen = i,
		},
...
for i = 1, 5 do
newEntity{ base = "BASE_TINKER", define_as = "TINKER_ARCANE_DYNAMO"..i,
	name = "arcane dynamo", image = "object/tinkers_arcane_dynamo.png",
	on_type = "armor", on_subtype = "cloth",
	metallic = true,
	material_level = i,
	special_desc = function(self) return _t"Allows the use of Technomancy spells." end,
	object_tinker = {
		wielder = {
			learn_talent = {[Talents.T_TINKER_ARCANE_DYNAMO] = i},
		},
	},
}
end
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_SHOCKING_TOUCH"..i,
	name = ("%s shocking touch"):tformat(metals[i]), image = "object/tinkers_shocking_touch_t5.png",
	on_slot = "HANDS",
	material_level = i,
	metallic = true,
	object_tinker = {
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_DEFLECTION_FIELD"..i,
	name = ("%s deflection field"):tformat(metals[i]), image = "object/tinkers_deflection_field_t5.png",
	on_slot = "BELT",
	material_level = i,
	metallic = true,
	object_tinker = {
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_GALVANIC_RETRIBUTOR"..i,
	name = ("%s galvanic retributor"):tformat(metals[i]), image = "object/tinkers_galvanic_retribution_t5.png",
	...
	on_tinker = function(self, o, who)
		...
		o.on_block = {desc = _t"Unleash a lightning nova of radius equal to the tinker tier.", fct = function(self, who, target, type, dam, eff)
...
-- 	name = ("%s gauss accelerator"):tformat(metals[i]), image = "object/tinkers_viral_needlegun_t5.png",
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_SHOCKING_EDGE"..i,
	name = ("%s shocking edge"):tformat(metals[i]), image = "object/tinkers_shocking_edge_t5.png",
	on_type = "weapon",
	material_level = i,
	metallic = true,
	special_desc = function(self) return _t"Deals lightning damage and drains resources." end,
	on_tinker = function(self, o, who)
		local DamageType = require "engine.DamageType"
		if not o.combat then return true end
		...
		o:orcsWeaponAddOnEffect("special_on_hit", "shocking_edge", {desc=("shock your foe dealing %d damage and draining some of their resources"):tformat(o.combat.shocking_edge_damage(self, o, who)) , fct=function(combat, who, target)
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_SAW_STORM5",--Electricity Capstone
	...
	name = "Stormcutter",
	unided_name = _t"electrified steamsaw", unique = true,
	desc = _t[["Great for combat, cooking, and shaving! We accept no responsibility for ruined follicles."]],
	require = { stat = { str=48 }, },
	cost = 900,
	material_level = 5,
	rarity = false,
	combat = {
		...
		dammod = {str=1},
		block = 100,
		special_on_hit = {desc=_t"deal lightning damage to the target based on cunning with a 25% chance to daze, and arc to up to 3 targets.", fct=function(combat, who, target)
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_VOLTAIC_SENTRY"..i,
	name = ("%s voltaic sentry"):tformat(metals[i]), image = "object/tinkers_voltaic_sentry_t5.png",
	on_slot = "HANDS",
	material_level = i,
	metallic = true,
	object_tinker = {
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_MENTAL_STIMULATOR"..i,
	name = ("%s mental stimulator"):tformat(metals[i]), image = "object/tinkers_mental_stimulator_t5.png",
	on_slot = "HEAD",
	material_level = i,
	metallic = true,
	object_tinker = {
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_POWER_DISTRIBUTOR"..i,
	name = ("%s power distributor"):tformat(metals[i]), image = "object/tinkers_power_distributor_t5.png",
	on_slot = "BELT",
	material_level = i,
	metallic = true,
	object_tinker = {
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_WHITE_LIGHT_EMITTER"..i,
	name = ("%s white light emitter"):tformat(metals[i]), image = "object/tinkers_white_light_emitter_t5.png",
	on_slot = "LITE",
	material_level = i,
	metallic = true,
	object_tinker = {	
