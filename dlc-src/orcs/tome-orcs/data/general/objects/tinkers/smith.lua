...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_FOCUS_LEN"..i,
	name = ("%s focus lens"):tformat(simple[i]), image = "object/tinkers_focus_len_t5.png",
	on_slot = "HEAD",
	material_level = i,
	metallic = true,
	object_tinker = {
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_TOXIC_CANNISTER_LAUNCHER"..i,
	name = ("%s toxic cannister launcher"):tformat(metals[i]), image = "object/tinkers_toxic_cannister_launcher_t5.png",
	on_slot = "HANDS",
	material_level = i,
	metallic = true,
	object_tinker = {
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_VIRAL_NEEDLEGUN"..i,
	name = ("%s viral needlegun"):tformat(metals[i]), image = "object/tinkers_viral_needlegun_t5.png",
	on_slot = "HANDS",
	material_level = i,
	metallic = true,
	object_tinker = {
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_RAZOR_EDGE"..i,
	name = ("%s razor edge"):tformat(metals[i]), image = "object/tinkers_razor_edge_t5.png",
	on_type = "weapon",
	material_level = i,
	metallic = true,
	object_tinker = {
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_ARMOUR_REINFORCEMENT"..i,
	name = ("%s armour reinforcement"):tformat(metals[i]), image = "object/tinkers_armour_reinforcement_t5.png",
	on_slot = "BODY",
	material_level = i,
	metallic = true,
	object_tinker = {
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_CRYSTAL_EDGE"..i,
	name = ("%s crystal edge"):tformat(metals[i]), image = "object/tinkers_crystal_edge_t5.png",
	on_type = "weapon",
	material_level = i,
	special_desc = function(self) return _t"Deals high light damage and increases critical multiplier." end,
	metallic = true,
	object_tinker = {
		wielder = {
	...
	on_tinker = function(self, o, who)
		...
		o:orcsWeaponAddOnEffect("special_on_hit", "crystal_edge", {desc=("flashes light on your target dealing %d damage"):tformat(o.combat.crystal_edge_damage(self, o, who)) , fct=function(combat, who, target)
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_CRYSTAL_PLATING"..i,
	name = ("%s crystal plating"):tformat(metals[i]), image = "object/tinkers_crystal_plating_t5.png",
	on_slot = "BODY",
	material_level = i,
	metallic = true,
	object_tinker = {
		wielder = {
			inc_stats = { [Stats.STAT_STR] = 2*i, [Stats.STAT_MAG] = 2*i, [Stats.STAT_DEX] = 2*i, [Stats.STAT_CUN] = 2*i, [Stats.STAT_CON] = 2*i, [Stats.STAT_WIL] = 2*i },
		},
	},
}
end
...
newEntity{
	...
	unided_name = _t"plated gauntlets", unique = true,
	desc = _t[[From your hands have been wrought incredible works. Your works have been forged in fire, and so have you.]],
	encumber = 1.5,
	cost = 900,
	material_level=5,
	metallic = true,
	special_desc = function(self) return _t"On landing any melee attack, release a fiery shockwave, dealing fire and physical damage each equal to your steampower in a cone from the target of radius 3." end,
	wielder={
		max_encumber = 20,
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_SPIKE_ATTACHMENT"..i,
	name = ("%s spike attachment"):tformat(metals[i]), image = "object/tinkers_spike_attachment_t5.png",
	on_slot = "BODY",
	material_level = i,
	metallic = true,
	object_tinker = {
		wielder = {
			fatigue = 1,
			combat_armor = 4*i,
			on_melee_hit={[DamageType.PHYSICAL] = 10*i},
		},
	},
}
end
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_SILVER_FILIGREE"..i,
	name = ("%s silver filigree"):tformat(metals[i]), image = "object/tinkers_silver_filigree_t5.png",
	on_type = "weapon",
	material_level = i,
	metallic = true,
	object_tinker = {
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_BACK_SUPPORT"..i,
	name = ("%s back support"):tformat(metals[i]), image = "object/tinkers_back_support_t5.png",
	on_slot = "BELT",
	material_level = i,
	metallic = true,
	object_tinker = {
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_GROUNDING_STRAP"..i,
	name = ("%s grounding strap"):tformat(metals[i]), image = "object/tinkers_grounding_strap_t5.png",
	on_slot = "CLOAK",
	material_level = i,
	metallic = true,
	object_tinker = {
