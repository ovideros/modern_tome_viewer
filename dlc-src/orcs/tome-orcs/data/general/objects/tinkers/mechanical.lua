...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_ROCKET_BOOTS"..i,
	name = ("%s rocket boots"):tformat(metals[i]), image = "object/tinkers_rocket_boots_t5.png",
	on_slot = "FEET",
	material_level = i,
	metallic = true,
	object_tinker = {
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_HAND_CANNON"..i,
	name = ("%s hand cannon"):tformat(metals[i]), image = "object/tinkers_hand_cannon_t5.png",
	on_slot = "HANDS",
	material_level = i,
	metallic = true,
	object_tinker = {
...
-- 	name = ("%s 1H weapon automaton"):tformat(metals[i]), image = "object/tinkers_weapon_automaton_t5.png",
-- 	on_slot = "HANDS",
-- 	material_level = i,
-- 	metallic = true,
-- 	object_tinker = {
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_FATAL_ATTRACTOR"..i,
	name = ("%s fatal attractor"):tformat(metals[i]), image = "object/tinkers_fatal_attractor_t5.png",
	on_slot = "HANDS",
	material_level = i,
	metallic = true,
	object_tinker = {
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_IRON_GRIP"..i,
	name = ("%s grip"):tformat(metals[i]), image = "object/tinkers_iron_grip_t5.png",
	on_slot = "HANDS",
	material_level = i,
	metallic = true,
	object_tinker = {
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_SPRING_GRAPPLE"..i,
	name = ("%s grapple"):tformat(metals[i]), image = "object/tinkers_spring_grapple_t5.png",
	on_slot = "HANDS",
	material_level = i,
	metallic = true,
	object_tinker = {
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_POWER_ARMOUR5",
	...
	require = { stat = { str=60 }, flag = { "allow_wear_massive" }, },
	encumber = 22,
	metallic = true,
	desc = _t[[Using small steam engines and the miracles of the latest automation discoveries you are able to create Steam Powered Armour. A full plate armour that helps your movement and has intrinsic protection mechanisms.]],
	cost = 1200,
	material_level = 5,
	wielder = {
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_SAW_PROJECTOR"..i,
	name = ("%s saw projector"):tformat(metals[i]), image = "object/tinkers_saw_projector_t5.png",
	on_slot = "HANDS",
	material_level = i,
	metallic = true,
	object_tinker = {
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_KINETIC_STABILISER"..i,
	name = ("%s kinetic stabiliser"):tformat(metals[i]), image = "object/tinkers_kinetic_stabiliser_t5.png",
	on_slot = "FEET",
	material_level = i,
	metallic = true,
	object_tinker = {
