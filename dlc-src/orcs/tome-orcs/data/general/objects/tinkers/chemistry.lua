...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_POISON_GROOVE"..i,
	name = ("%s poison groove"):tformat(simple[i]), image = "object/tinkers_poison_groove_t"..i..".png",
	on_type = "weapon",
	material_level = i,
	metallic = true,
	special_desc = function(self) return _t"Deals stacking poison damage." end,
	on_tinker = function(self, o, who)
		...
		o:orcsWeaponAddOnEffect("special_on_hit", "poison_groove", {desc=("applies a stacking poison dealing %d damage per turn"):tformat(o.combat.poison_groove_damage(self, o, who)) , fct=function(combat, who, target)
			local DamageType = require "engine.DamageType"
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_VIRAL_INJECTOR"..i,
	name = ("%s viral injector"):tformat(simple[i]), image = "object/tinkers_viral_injector_t"..i..".png",
	on_type = "weapon",
	material_level = i,
	metallic = true,
	special_desc = function(self) return _t"Infects targets with a stat reducing disease." end,
	on_tinker = function(self, o, who)
		local DamageType = require "engine.DamageType"
		...
		o:orcsWeaponAddOnEffect("special_on_hit", "viral_injector", {desc=("injects a simple virus dealing %d blight damage on hit and lowering the victims highest stat"):tformat(o.combat.viral_injector_damage(self, o, who)), fct=function(combat, who, target)
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_WINTERCHILL_EDGE"..i,
	name = ("%s winterchill edge"):tformat(simple[i]), image = "object/tinkers_winterchill_edge_t"..i..".png",
	on_type = "weapon",
	material_level = i,
	metallic = true,
	special_desc = function(self) return _t"Deals cold damage and slows." end,
	on_tinker = function(self, o, who)
		local DamageType = require "engine.DamageType"
		...
		o:orcsWeaponAddOnEffect("special_on_hit", "winterchill_edge", {desc=("chills your foe dealing %d damage and slowing them by one tenth of a turn"):tformat(o.combat.winterchill_edge_damage(self, o, who)) , fct=function(combat, who, target)
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_ACID_GROOVE"..i,
	name = ("%s acid groove"):tformat(simple[i]), image = "object/tinkers_acid_groove_t"..i..".png",
	on_type = "weapon",
	material_level = i,
	metallic = true,
	special_desc = function(self) return _t"Deals acid damage that also reduces armour." end,
	on_tinker = function(self, o, who)
		local DamageType = require "engine.DamageType"
		if not o.combat then return true end
		...
		o:orcsWeaponAddOnEffect("special_on_hit", "acid_groove", {desc=("splashes acid on your target dealing %d damage and reducing their armor"):tformat(o.combat.acid_groove_damage(self, o, who)) , fct=function(combat, who, target)
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_WATERPROOF_COATING"..i,
	name = ("%s waterproof coating"):tformat(simple[i]), image = "object/tinkers_waterproof_coating_t5.png",
	on_slot = "CLOAK",
	material_level = i,
	object_tinker = {
		wielder = {
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_FIREPROOF_COATING"..i,
	name = ("%s fireproof coating"):tformat(simple[i]), image = "object/tinkers_fireproof_coating_t5.png",
	on_slot = "CLOAK",
	material_level = i,
	object_tinker = {
		wielder = {
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_FLASH_POWDER"..i,
	name = ("%s flash powder"):tformat(simple[i]), image = "object/tinkers_flash_powder_t5.png",
	on_slot = "HANDS",
	material_level = i,
	metallic = true,
	object_tinker = {
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_ITCHING_POWDER"..i,
	name = ("%s itching powder"):tformat(simple[i]), image = "object/tinkers_itching_powder_t5.png",
	on_slot = "HANDS",
	material_level = i,
	metallic = true,
	object_tinker = {
...
newEntity{
	...
	unided_name = _t"action packed cloak",
	...
	metallic = true,
	use_no_energy=true,
	special_desc = function(self) return _t"On falling below 20% of your max life, releases a cloud of smoke, confusing nearby enemies and giving you stealth and a chance to avoid incoming damage for 5 turns." end,
	wielder = {
	...
	use_power = {
		name = function(self, who) return _t"cause the next damage you deal to inflict crippling poison (does not recharge until used), dealing minor poison damage and causing your target to have a 10% chance to fail all talents" end,
		power = 12,
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_RUSTPROOF_COATING"..i,
	name = ("%s rustproof coating"):tformat(simple[i]), image = "object/tinkers_rustproof_coating_t5.png",
	on_slot = "BODY",
	special_desc = function(self) return ("%d%% chance to avoid a detrimental acid subtype effect."):tformat(self.object_tinker.wielder.corrode_resist) end,
	material_level = i,
	metallic = true,
	object_tinker = {
		wielder = {
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_ALCHEMISTS_HELPER"..i,
	name = ("%s alchemist's helper"):tformat(simple[i]), image = "object/tinkers_alchemists_helper_t5.png",
	on_slot = "BELT",
	material_level = i,
	object_tinker = {
		wielder = {
...
newEntity{ base = "BASE_TINKER", define_as = "TINKER_BLACK_LIGHT_EMITTER"..i,
	name = ("%s black light emitter"):tformat(simple[i]), image = "object/tinkers_black_light_emitter_t5.png",
	on_slot = "LITE",
	material_level = i,
	object_tinker = {
		wielder = {
