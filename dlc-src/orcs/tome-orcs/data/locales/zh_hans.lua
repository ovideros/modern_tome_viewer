...
t("[reprogram it to order it to relocate to Kruk Pride]", "[改写程序，令其迁移至克鲁克部落]", "_t")
t("[leave]", "[离开]", "_t")
t("#LIGHT_GREEN#*You tinker with the store bot and manage to activate the relocation function.*#WHITE#", "#LIGHT_GREEN#*你操作了商店设备，执行了迁移程序。*#WHITE#", "_t")
...
t("REGRET!", "悔恨！", "_t")
t("My love...", "我的爱人…", "_t")
t("I feel so lost.", "我迷失了。", "_t")
t("Please let me die!", "让我去死吧！", "_t")
t("RAAAAARGGGG!", "额啊啊啊啊啊阿！", "_t")
t("Someday you will pay!", "总有一天你会付出代价的！", "_t")
t("DEATH!", "去死吧!", "_t")
t("*Sobs*", "*哭泣*", "_t")
...
Do you still wish to take this path?]], [[反魔法是一系非常特殊的技能。你学习后将不能使用奥术装备和法术技能。
确定要学习么？]], "_t")
t("No.", "不。", "_t")
t("Yes!", "好的！", "_t")
t("Select the party member to receive the reward:", "选择队伍中获得奖励的成员：", "_t")
t("Very well. We can teach you a talent category; which do you want?", "很好，我们能教你一个技能树；你想要哪种？", "_t")
t("Physical techniques", "战斗技术", "_t")
...
t("Kruk Pride", "克鲁克部落", "faction name")
t("Free Whitehooves", "自由白蹄", "faction name")
t("Whitehooves", "白蹄", "faction name")
t("Kar'Haïb Dominion", "卡尔·亥巴巨魔帝国", "faction name")
t("Atmos Tribe", "气之部族", "faction name")
t("Kaltor's Shop", "卡托尔的商店", "faction name")
t("Amakthel", "阿马克泰尔", "faction name")
...
t("Tinker Cave", "工匠的山洞", "entity name")
t("harmless", "无害", "entity type")
t("special", "特殊", "entity subtype")
t("Entrance the tinker's master cave", "前往工匠大师山洞的入口", "_t")
...
t("corrupted geothermal drill", "被污染的地热钻头", "_t")
t("geothermal drill", "地热钻头", "_t")
t("A huge geothermal drill, pumping heat and steam from Eyal's crust.", "一个巨大的地热钻，从埃亚尔的地壳中抽取热量和蒸汽。", "_t")

------------------------------------------------
section "tome-orcs/data/general/events/herbs.lua"

t("pile of herbs", "一堆草药", "_t")
t("A little stockpile of herbs, whomever left them there should be thanked.", "一小堆草药，不管是谁留在这里的，真应该谢谢他。", "_t")
t("#OLIVE_DRAB#You carefully pickup the stack of herbs.", "#OLIVE_DRAB#你小心地捡起了一堆草药。", "log")
...
t("manacave ground", "法力山洞地面", "entity name")
...
t("floor", "地板", "entity type")
t("corrupted cave", "被污染的山洞", "entity subtype")
t("corrupted cave floor", "被污染的山洞地板", "entity name")
t("wall", "墙壁", "entity type")
...
t("alligator", "鳄鱼", "entity subtype")
t("sewer alligator", "下水道鳄鱼", "entity name")
t("How cliche!", "多么的老套！", "_t")
...
t("saw horror", "链锯恐魔", "entity name")
t("Oh. Oh no. Where did it get those?", "哦。哦不。它是怎么弄到这些的？", "_t")
...
t("drone", "无人机", "entity subtype")
t("steam drone", "蒸汽机器人", "entity name")
...
t("steam giant blood carver", "蒸汽巨人血雕者", "entity name")
t("Blood seems to ooze from the towering giant, yet seemingly to no ill effect.", "尽管血液不停地从这个高大的巨人身上渗出，他看上去却没有任何不适。", "_t")
...
t("giant", "巨人", "entity type")
t("steam", "蒸汽", "entity subtype")
t("steam giant gunner", "蒸汽巨人枪手", "entity name")
t("This steam giant is carrying a powerful looking gun.", "这个蒸汽巨人拿着一把看上去威力很强的枪。", "_t")
t("steam giant gunslinger", "蒸汽巨人快枪手", "entity name")
t("This steam giant carries a steamgun in each hand.", "这个蒸汽巨人双手各拿着一把蒸汽枪。", "_t")
t("steam giant flameshot", "蒸汽巨人火焰射手", "entity name")
t("This steam giant carries a steamgun in each hand. The barrels appear to be flaming.", "这个蒸汽巨人双手各拿着一把枪管在燃烧的蒸汽枪。", "_t")
t("retaliator of Atmos", "阿特姆斯复仇者", "entity name")
t("This steam giant carries a steamgun in each hand. She is here to eliminate any and all aggression towards the Atmos tribe.", "这个蒸汽巨人双手各拿着一把蒸汽枪。她来此唯一的目的就是消灭任何对阿特姆斯部落的威胁。", "_t")
...
t("giant", "巨人", "entity type")
t("steam", "蒸汽", "entity subtype")
t("steam giant guard", "蒸汽巨人守卫", "entity name")
t("This titanic figure walks towards you, a massive sword and shield in each hand.", "这个拿着巨型剑盾的庞大人形正在向你走来。", "_t")
t("steam giant berserker", "蒸汽巨人狂战士", "entity name")
t("This steam giant carries a massive greatsword with both hands, and you see a cloud of thick steam enveloping the blade.", "这个蒸汽巨人双手拿着一柄无比庞大的大剑，你看到剑刃被厚厚的蒸汽云团包裹着。", "_t")
t("steam giant yeti rider", "蒸汽巨人雪人骑士", "entity name")
t("Riding atop a massive armored yeti, this steam giant wields a huge greatsword.", "这个拿着大剑的蒸汽巨人骑在一只重甲雪人身上。", "_t")

------------------------------------------------
section "tome-orcs/data/general/npcs/steam-spiders.lua"

t("mechanical", "机械", "entity type")
t("arachnid", "蜘蛛", "entity subtype")
...
t("sun-mage recruit", "太阳法师新兵", "entity name")
t("A mage dressed in glowing robes.", "一个穿着荧光法袍的法师。", "_t")
t("sun-mage", "太阳法师", "entity name")
t("A mage dressed in shining robes.", "一个穿着闪亮法袍的法师。", "_t")
t("anorithil", "星月术士", "entity name")
t("A mage dressed in ornate robes depicting both light and darkness.", "一个穿着同时描绘了光与暗的华丽法袍的法师。", "_t")
t("astral conjurer", "星空咒术师", "entity name")
...
t("The shield of this soldier glows with a bright light. You see a golden sun engraved in its center, and he carries a sword in his other hand.", "这个士兵的盾牌闪耀着强光。你看到盾牌的中央雕刻着一个金色的太阳，同时他的另一只手拿着一柄剑。", "_t")
t("sun paladin", "太阳骑士", "entity name")
t("The shield and sword of this soldier glow with a bright light. You see a golden sun engraved in the shield's center.", "这个士兵的盾牌与剑都闪耀着强光。你看到盾牌的中央雕刻着一个金色的太阳。", "_t")
t("sunwall vindicator", "太阳堡垒维护者", "entity name")
t("This mean looking soldier of the Sunwall holds steady his big two handed weapon, looking dangerously at you.", "这个看上去十分凶恶的太阳堡垒士兵稳稳地握着一柄双手剑，他正在用危险的目光看着你。", "_t")

------------------------------------------------
section "tome-orcs/data/general/npcs/titan.lua"

t("giant", "巨人", "entity type")
t("titan", "泰坦", "entity subtype")
t("titan battlesmasher", "泰坦碎颅者", "entity name")
t("This creature looks like one of the steam giants, but nastier, bigger and somehow corrupted by unknown forces. Oh and it is wielding a huge maul too!", "这个生物看上去像是一个蒸汽巨人，但是更巨大，更恶心，并且被某种未知力量腐化了。天啊，他还拿着一个巨锤！", "_t")
...
t("The skeleton of a long-lived wyrm, armed with a deadly breath weapon and nasty claws.", "一只活了很久的巨龙的骷髅，有着致命的吐息和可怕的利爪。", "_t")
...
t("whitehoof ghoul", "白蹄尸鬼", "entity name")
t("It is a cross between a human and a bull, but more ... dead.", "他像是人类和公牛组合出来的，除了更……死。", "_t")
...
t("giant", "巨人", "entity type")
t("yeti", "雪人", "entity subtype")
t("yeti cub", "雪人幼崽", "entity name")
t("This humanoid form is coated with a thick white fur.", "这个类人生物身上长着厚实的白毛。", "_t")
t("yeti", "雪人", "entity name")
t("This large humanoid form is coated with a thick white fur.", "这个大型的类人生物身上长着厚实的白毛。", "_t")
t("yeti warrior", "雪人勇士", "entity name")
t("This huge humanoid form is coated with a thick white fur, with large, vicious claws. It looks angry.", "这个巨大的类人生物身上长着厚实的白毛，和危险的巨爪。他看上去十分愤怒。", "_t")
t("yeti demolisher", "雪人爆破者", "entity name")
t("This huge humanoid form is coated with a thick white fur, with large, vicious claws. Will you welcome the embrace of its large muscular arms?", "这个巨大的类人生物身上长着厚实的白毛，和危险的巨爪。你会喜欢被他肌肉满满的双臂拥抱一下吗？", "_t")
...
t(" of tinkering (#STATBONUS#)", "工匠之(#STATBONUS#)", "entity name")
t("tinker", "工匠", "entity keyword")
t("gunslinger's ", "快枪手的", "entity name")
t("gunslinger", "快枪手", "entity keyword")
t("strafer's ", "扫射的", "entity name")
t("strafer", "扫射", "entity keyword")
t(" of life draining", "吸血之", "entity name")
t("draining", "吸血", "entity keyword")
t("overgrown ", "茂盛的", "entity name")
t("overgrown", "茂盛", "entity keyword")
...
t("A hat made of leather. Very stylish.", "一顶皮帽。非常时髦。", "_t")
t("rough leather hat", "粗制皮帽", "entity name")
...
t("tinker", "蒸汽工具", "entity type")
t("power", "能量", "entity subtype")
...
t("Melt all %d item(s) on the floor?", "转化地面上的%d件物品吗？", "tformat")
t("Melt all %d item(s) in your APE?", "转化便携式自动材料提取仪里的%d件物品吗？", "tformat")
...
t("kruk cloak", "克鲁克披风", "entity name")
t("kruk", "克鲁克", "entity short_name")
t("A stylish kruk-style cloak, to look awesome.", "一件时髦的克鲁克风格披风，让你看起来很酷。", "_t")
...
能装备在主手或者副手。
滋滋滋！！！]], "_t")
t("iron steamsaw", "铁质蒸汽链锯", "entity name")
t("iron", "铁", "entity short_name")
...
t("tinker", "蒸汽工具", "entity type")
t("steamtech", "蒸汽科技", "entity subtype")
t("Tinkers can be attached to normal items to improve them with steam power!", "蒸汽工具可以被安装到普通物品上，用蒸汽力量强化它！", "_t")
t("misc", "杂项", "entity type")
t("salve", "药剂", "entity subtype")
t("salve", "药剂", "_t")
t("Medical salve.", "医用药剂", "_t")
...
t("project a beam of lightning", "制造闪电射线", "_t")
t("%s mana coil", "%s 魔力线圈", "tformat")
t("Mana regeneration, on spell hit 25%% chances to cast lightning.", "魔力回复，法术命中有25%%几率触发闪电术。", "_t")
t("arcane dynamo", "奥术发电机", "entity name")
t("Allows the use of Technomancy spells.", "允许使用科技法术。", "_t")
t("HANDS", "手部", "entity on slot")
...
t("HEAD", "头部", "entity on slot")
t("%s mental stimulator", "%s 精神刺激装置", "tformat")
t("%s power distributor", "%s 能量分配装置", "tformat")
t("LITE", "灯具", "entity on slot")
t("%s white light emitter", "%s 白光发射装置", "tformat")
...
t("%s voltaic shell", "%s 伏特弹", "tformat")
t("%s antimagic shell", "%s 反魔弹", "tformat")
t("%s botanical shell", "%s 植物弹", "tformat")
t("%s corrosive shell", "%s 腐蚀弹", "tformat")
t("%s toxic shell", "%s 毒气弹", "tformat")
...
t("Steam Powered Armour", "蒸汽动力装甲", "entity name")
t("Using small steam engines and the miracles of the latest automation discoveries you are able to create Steam Powered Armour. A full plate armour that helps your movement and has intrinsic protection mechanisms.", "使用小型蒸汽机和你最新发现的自动化技术，你可以制造蒸汽动力装甲。这个板甲增强你的行动能力并提供强大的防护能力。", "_t")
t("The more steam the better!", "蒸汽越多越好！", "_t")
t("#GOLD#Your steam-powered boots, helm and gauntlets automatically connect to your steam-powered armour, enabling new functions.", "#GOLD#你的蒸汽动力靴、头盔和手套自动连接到你的蒸汽动力装甲，获得新的功能。", "logSeen")
t("#GOLD#Your steam-powered armor disconnects from the other pieces.", "#GOLD#你的蒸汽动力装甲与其他组件断线了。", "logPlayer")
t("%s saw projector", "%s 链锯发射装置", "tformat")
t("%s kinetic stabiliser", "%s 动能稳定装置", "tformat")
...
t("HANDS", "手部", "entity on slot")
t("%s toxic cannister launcher", "%s 毒罐发射装置", "tformat")
t("%s viral needlegun", "%s 病毒针枪", "tformat")
t("%s razor edge", "%s 锐利刀片", "tformat")
t("BODY", "躯体", "entity on slot")
...
t("BELT", "腰带", "entity on slot")
t("%s back support", "%s 脊椎牵引装置", "tformat")
t("CLOAK", "斗篷", "entity on slot")
t("%s grounding strap", "%s 接地导线", "tformat")
...
t("HEAD", "头部", "entity on slot")
t("%s air recycler", "%s 空气循环装置", "tformat")
t("Returns %d air each turn.", "每回合恢复%d空气。", "tformat")
t("FEET", "脚部", "entity on slot")
t("%s moss tread", "%s 苔藓之足", "tformat")
t("BELT", "腰带", "entity on slot")
t("%s fungal web", "%s 真菌之网", "tformat")
t("Heals you for %d life when you use a salve.", "当你使用药剂的时候，恢复%d生命值。", "tformat")
...
t("forge", "锻炉", "entity name")
t("smith", "铁匠", "entity name")
t("tinker", "蒸汽工具", "entity name")
t("expensive goods", "昂贵货物", "entity name")
t("aracane psi collector", "奥术灵能收集者", "entity name")
...
“不用了。我能感受到它的力量，多么熟悉而又新鲜的力量……这就是阿马克泰尔之眼本体的力量！它是多么的令人沉醉啊，很快，所有人都会感受到它的美丽…”
...
“这是阿马克泰尔在亲自奖励你对他的服侍，是你所应得的荣耀。”更多的撞击声。“这是神给你的祝福。一具更美好的全新的身躯。一个更美好的全新的灵魂。你的人民都可以得到这份…”
...
t("internment camp", "兽人拘留营", "newLore category")
t("internment camp correspondence (1)", "拘留营信件 (1)", "_t")
...
t("krimbul clan", "克里布尔部族", "newLore category")
t("the journey of the Krimbul Clan", "克里布尔部族的历史", "_t")
...
]], [[[i](你看到了一双被黑色皮手套包裹的腐烂的人手，手腕被切断了。它的手里拿着一个破碎的神器，样子就像是多元水晶球，水晶球和他的手掌之间夹着一张纸条。)[/i]
...
t("a telepathic message <The Eidolon>", "灵能传讯<艾德隆>", "_t")
...
t("sunwall", "太阳堡垒", "newLore category")
t("a page from Commander Trelle's journal", "指挥官特瑞尔日记的一页", "_t")
...
t("telepathic message (1)", "心灵传讯 (1)", "_t")
...
DO YOU KNOW OUR NAME?#{normal}#]], [[#{bold}#维西

你知道我们的名字吗？#{normal}#]], "_t")
t([[#{italic}#(Somehow the name seems to have faded from your memory!)#{normal}#

DO YOU KNOW OUR NAME?#{normal}#]], [[#{italic}#（不知为何，这个名字从你的记忆中消失了！）#{normal}#
...
t("Keep on killing mechanical contraptions or steam-related foes...", "请继续杀死机械装置，或和蒸汽有关的敌人……", "_t")
t("#LIGHT_GREEN#* You destroyed a mecharachnid equiped with a flamethrower. Both those things could prove very useful.#WHITE#", "#LIGHT_GREEN#* 你摧毁了一个装备火焰喷射器的机械蜘蛛。这两样东西将来都会很有用。#WHITE#", "_t")
t("#LIGHT_GREEN#* You have studied the 'remains' of an greater or ultimate hethugoroth, providing new ideas for ways to annihilate with heat.#WHITE#", "#LIGHT_GREEN#* 你研究了一个大型或终极赫斯格鲁斯的“遗骸”。这为你如何用热歼灭敌人提供了新的思路。#WHITE#", "_t")
t("#LIGHT_GREEN#* The impressive Automated Defense System remains will prove very useful to create automated and self-deploying constructs.#WHITE#", "#LIGHT_GREEN#* 这种令人印象深刻的自动防御系统的残骸，对制造可以自动部署的自动化机械十分有用。#WHITE#", "_t")
...
t("#GREY#* You need to have free the Rak'Shor Pride orcs.#WHITE#", "#GREY#* 你必须解放拉克·肖部落的兽人。#WHITE#", "_t")
t("#LIGHT_GREEN#* You have freed all the Gorbat Pride orcs.#WHITE#", "#LIGHT_GREEN#* 你解放了加伯特部落的兽人。#WHITE#", "_t")
t("#GREY#* You need to have free the Gorbat Pride orcs.#WHITE#", "#GREY#* 你必须解放加伯特部落的兽人。#WHITE#", "_t")
t("#LIGHT_GREEN#* You have freed all the Grushnak Pride orcs.#WHITE#", "#LIGHT_GREEN#* 你解放了格鲁希纳克部落的兽人。#WHITE#", "_t")
t("#GREY#* You need to have free the Grushnak Pride orcs.#WHITE#", "#GREY#* 你必须解放格鲁希纳克部落的兽人。#WHITE#", "_t")
t("#LIGHT_GREEN#* The Pride is once again free and united.#WHITE#", "#LIGHT_GREEN#* 部落重获自由，更加团结。#WHITE#", "_t")
-- untranslated text
--[==[
t("", "", "_t")
--]==]
...
t("Tower Detonator", "塔楼炸弹", "_t")
t("This bomb was tailored to weaken the structure of the Dominion's port tower. If placed at the right spot it will explode after 100 turns and destroy the whole port.", "这枚炸弹是为削弱帝国港口塔楼的结构而特制的。如果放在正确的位置，它会在100回合后爆炸并摧毁整个港口。", "_t")
t("place the bomb on the structural weakness.", "将炸弹放在建筑的弱点处。", "_t")
...
t("No Fumes Without Fire", "无火不起烟", "_t")
t("The time for revenge is at hand! The Tribe stands crippled under your assaults.", "复仇的时刻终于到了！气之部族在你的攻击下濒临瘫痪！", "_t")
t("Enter the Palace of Fumes and crush their leaders once and for all!", "攻入烟雾宫殿，彻底粉碎他们的领袖！", "_t")
t("For Kruk!", "为了克鲁克！", "_t")
t("For the Prides!", "为了部落！", "_t")
t("For the Garkul!", "为了加库尔！", "_t")
t("#LIGHT_GREEN#* Council Member Nashal is dead.#WHITE#", "#LIGHT_GREEN#* 议会成员纳沙尔死了。#WHITE#", "_t")
t("#LIGHT_GREEN#* Council Member Tormak is dead.#WHITE#", "#LIGHT_GREEN#* 议会成员托马克死了。#WHITE#", "_t")
t("#LIGHT_GREEN#* Council Member Pendor is dead.#WHITE#", "#LIGHT_GREEN#* 议会成员潘多尔死了。#WHITE#", "_t")
t("#LIGHT_GREEN#* Council Member Palaquie is dead.#WHITE#", "#LIGHT_GREEN#* 议会成员帕拉奎死了。#WHITE#", "_t")
t("#LIGHT_GREEN#* Council Member Tantalos is dead.#WHITE#", "#LIGHT_GREEN#* 议会成员坦塔洛斯死了。#WHITE#", "_t")
t("#LIGHT_GREEN#* You have destroyed the Council and shattered the Tribe.#WHITE#", "#LIGHT_GREEN#* 你摧毁了他们的议会，气之部族分崩离析！#WHITE#", "_t")
t("What is all this noise about!", "这是什么声音！", "_t")
t("Tantalos! What have you done!", "坦塔洛斯！你都干了些什么！", "_t")
-- untranslated text
--[==[
t("", "", "_t")
--]==]
...
t("#LIGHT_GREEN#* You have destroyed the sunwall outpost, and secured a way to the mainland.#WHITE#", "#LIGHT_GREEN#* 你已经摧毁了太阳堡垒前哨站，确保了通向大陆的安全通路。#WHITE#", "_t")
t("To the mainland!", "前往大陆！", "_t")
t([[The way to the mainland is now clear.
Travel there using the bridge on the worldmap.]], [[前往大陆的障碍已经被清除了。
使用大地图上的桥来前往大陆。]], "_t")
...
t("Cosmic", "宇宙", "talent type")
t("Energies", "能量", "talent type")
...
t("steam", "蒸汽", "talent category")
t("object techniques", "物品战技", "talent type")
t("Steam powers of the various objects of the world.", "世界上各种物品的蒸汽能力。", "_t")
...
t("gestalt", "格式塔", "talent type")
t("Harness steam energies to power your own mind.", "利用蒸汽能量来驱动你自己的思想。", "_t")
t("action at a distance", "远程动作", "talent type")
t("Focus your mental energies to make things happen. Or combust.", "集中精神使事情发生。或者燃烧。", "_t")
t("psionic fog", "灵能之雾", "talent type")
t("Psionically manipulate steam to harass your foes and protect yourself.", "灵能操控蒸汽骚扰敌人并保护自己。", "_t")

------------------------------------------------
section "tome-orcs/data/talents/spells/galvanic-technomancy.lua"

t("Galvanic Rod", "放电柱", "talent name")
...
t([[You surge with a life draining energy for %d turns.
		While the effect lasts, you heal yourself for %d%% of all damage you deal.]], [[你激发一波吸血能量，持续 %d 回合。
...
t([[Throw a small, unstable steam engine on the battlefield that will go critical after 2 turns.
		...
		#{italic}#Tick Tock Tick BOOM!#{normal}#]], [[在战场上投掷一枚两回合后爆炸的微型不稳定蒸汽引擎。
...
t([[Explosive Steam Engine vapour now lingers for 5 turns.
		...
		伤害受蒸汽强度加成。
		#{italic}#尝尝最新科技带来的燃烧服务吧！#{normal}#]], "tformat")
...
t("Overheat Bullets", "过热子弹", "talent name")
...
t([[You coat your bullets with flammable materials, for the next %d turns each bullet will explode when it hits its target, dealing %0.2f fire damage to all foes within radius 2 (most of your shooting talents fire two bullets at once).
		Damage will increase with Steampower.
		Only one bullet enhancement can be used at once.]], [[在子弹上覆盖了可燃材料。在接下来的 %d 回合，子弹在击中目标后都会爆炸，对 2 码范围内的敌人造成 %0.2f 火焰伤害（大多数射击技能一次发射两枚弹药）。
		伤害随蒸汽强度提高。
		一次只能使用一种弹药强化能力。]], "tformat")
...
t([[Fires your ammo at an enemy in range %d for %d%% weapon damage.  If this tinker is made of voratun you will fire an additional shot.
			This shot is a ranged melee attack but will use the ranged procs of your ammo as well.]], [[向在 %d 码范围内的一个敌人开火造成 %d%% 的武器伤害。如果手炮是由沃瑞钽钢制作的，你能多一次额外的射击。射击是远程攻击将会触发弹药特效。
]], "tformat")
...
t("Molten Iron Blood", "铁水血液", "talent name")
...
t("Master of Disasters", "灾难之主", "talent name")
...
t("Technomancer", "科技法师", "talent name")
t("Unlocked the Technomancer evolution", "解锁科技法师职业进阶", "_t")
t("Technomancer", "科技法师", "_t")
t("Occult Technomancy", "科技法术：玄机", "_t")
t("These talents focus on arcane and temporal damage, using a super-spinned steamsaw to rip holes in reality.", "这一系技能专注于奥术和时空伤害，使用超高速旋转的蒸汽链锯切裂现实。", "_t")
t("Galvanic Technomancy", "科技法术：放电", "_t")
t("These talents focus on fire and lightning damage, strategically placing galvanic rods to create fields of death and stuns.", "这一系技能专注于火焰和闪电伤害，通过放置放电柱来创造电击力场，震慑并杀死敌人。", "_t")
t("Terrene Technomancy", "科技法术：寒岩", "_t")
t("These talents focus on cold and physical damage, summoning micro spiderbots to harass and pin their foes or protect themselves.", "这一系技能专注于寒冷和物理伤害，召唤微型蜘蛛机器人，干扰并定身敌人，或是用于保护自己。", "_t")
t("Choose your free Technomancy unlock?", "选择你免费解锁的科技法术？", "_t")
t([[Available talents:
]], [[可用技能：
]], "_t")
...
t("a steamtech power", "蒸汽科技", "_t")
t("a technomancy spell", "科技法术", "_t")
...
t("Starscape", "星界领域", "_t")
t("Has summoned the starscape, slowing all creatures 67%.", "召唤星界，减速所有生物 67% 。", "_t")
t("corruption", "堕落", "effect subtype")
t("Vampiric Surge", "吸血狂潮", "_t")
t("This unit is recovering %d%% of all damage it deals as health.", "将自己造成的 %d%% 伤害值转化为治疗。", "tformat")
t("#Target# is overflowing with dark power!", "#Target# 充满了黑暗能量!", "_t")
t("+Vamp Surge", "+吸血狂潮", "_t")
t("#Target#'s dark aura fades.", "#Target#的黑暗领域消退了。", "_t")
t("-Vamp Surge", "-吸血狂潮", "_t")
...
t("Deals %0.2f occult damage per turn and each time a talent is used, the caster regens one turn of a random cooldown.", "每回合受到 %0.2f 玄机伤害，每当其使用一个技能，这一状态施加者随机一个技能减少一回合冷却。", "tformat")
...
t("While Ethereal Steam exists the cooldown of Metaphasic Spin is reduced to 6.", "当虚幻蒸汽效果存在的时候，相位旋转技能冷却时间降低到6回合。", "tformat")
...
t("save", "豁免", "effect subtype")
t("Negative Biofeedback", "负反馈", "_t")
t("Physical save reduced by %d, armour and defense by %d.", "物理豁免下降 %d，护甲和闪避下降%d。", "tformat")
...
t("No Hope", "无助深渊", "_t")
t("All damage reduced by 40%%.", "所有伤害减少 40%%。", "tformat")
t("#Target# loses all hope of winning!", "#Target#失去了对胜利的希望！", "_t")
t("#Target# is once more confident.", "#Target#恢复了信心。", "_t")
...
t("Fight to the brink of death, can not die before going under -%d life (but life under 0 is not shown) and increases all resistances by %d%%.", "获得 -%d 生命下限和 %d%% 全体伤害抗性。", "tformat")
...
t("You lay moss where you walk.", "脚下长出苔藓。", "tformat")
t("+Moss", "+苔藓", "_t")
t("-Moss", "-苔藓", "_t")
t("Stimulus", "兴奋剂", "_t")
...
t("Mental Stimulator", "精神刺激装置", "_t")
t("Supercharge your thinking and give your brain a boost with the Mental Stimulator!", "强化你的思考能力，加速你的大脑！", "_t")
t("Power Distributor", "能量分配装置", "_t")
t("The Power Distributor V2 ensures you have the energy where and when you need it, without any of the side effects like V1 had.", "能量分配器V2可以确保你在任何需要的时候拥有充足的能源，并且不会像V1那样有什么负面作用。", "_t")
t("White Light Emitter", "白光发射装置", "_t")
t("Add more light to your light!", "给你的灯具加点光亮！", "_t")
...
t("diamond", "钻石", "_t")
t("bloodstone", "血滴石", "_t")
t("Explosive Shell", "爆炸弹", "_t")
t("A special shot that explodes on impact.", "击中时可以造成猛烈爆炸的特殊弹头。", "_t")
...
t("A special shot grows moss on impact.", "击中时会长出苔藓的特殊弹头。", "_t")
t("Toxic Shell", "毒气弹", "_t")
t("A special shot that contains a deadly toxin.", "带有致命毒素的特殊弹头。", "_t")
...
t("diamond", "钻石", "_t")
t("bloodstone", "血滴石", "_t")
t("Saw Projector", "链锯发射装置", "_t")
t("A mechanical device for launching a spinning buzzsaw! What else could you want?", "这个机械装置可以发射出一个旋转的链锯飞盘！你还指望什么呢？", "_t")
t("Kinetic Stabiliser", "动能稳定装置", "_t")
t("Helps keep your feet on the ground, but still allows mobility.", "可以把你的脚牢牢固定在地上，但不会影响你的移动能力。", "_t")

------------------------------------------------
section "tome-orcs/data/tinkers/smith.lua"

t("Steamsaw", "蒸汽链锯", "_t")
t("Dismantle any one handed sword/axe/mace, add some amazing steampower to it and make a powerful steamsaw to shred your foes to pieces!", "拆解一件单手剑/斧/锤，在上面加入令人惊异的蒸汽能力，让它变成可以把你的敌人撕成碎片的蒸汽链锯！", "_t")
t("a one handed sword/axe/mace (not unique, without a special damage type)", "一把单手剑/斧/锤（非神器，没有特殊伤害类型）", "_t")
...
t("Keeping yourself grounded is very important, especially around lightning mages.  Increases lightning and stun resistance.", "当你面对雷电法师的时候，保持自己的接地状态是很重要的。提高闪电伤害抗性和震慑抗性。", "_t")
...
t("shadow of pain", "痛之影", "entity name")
t("A shadowy embodiment of pain.", "一团由痛苦具现成的阴影。", "_t")
t("shadow of hate", "恨之影", "entity name")
t("A shadowy embodiment of hate.", "一团由恨意具现成的阴影。", "_t")
t("shadow of despair", "惘之影", "entity name")
t("A shadowy embodiment of despair.", "一团由绝望具现成的阴影。", "_t")
...
t("schematic: Rogue's Gallery", "配方：盗贼画廊", "entity name")

------------------------------------------------
section "tome-orcs/data/zones/cave-hatred/zone.lua"

t("Cave of Hatred", "仇恨洞穴", "_t")
t("#CRIMSON#You feel a great power nearby!", "#CRIMSON#你觉得附近有强大的力量！", "saySimple")

------------------------------------------------
section "tome-orcs/data/zones/dominion-port/grids.lua"

t("stale sewer water", "下水道污水", "entity name")
...
t("floor", "地板", "entity subtype")
t("structural weakness", "建筑弱点", "entity name")
t("booty chest", "战利品箱子", "entity name")
t("- #GOLD#%0.2f gold#LAST# worth of money", "- #GOLD#%0.2f 金币#LAST#", "tformat")
t("Booty chest", "战利品箱子", "_t")
...
t("a report", "一份报告", "entity name")
t("A report.", "一份报告。", "_t")
t("flesh", "肉", "entity type")
...
t("A small orb infused with the power of the Sun.", "一个注入了太阳能量的小球。", "_t")
t("moon orb", "月亮球", "entity name")
t("A small orb infused with the power of the Moons.", "一个注入了月亮能量的小球。", "_t")
t("elf", "精灵", "entity subtype")
t("Limmir the Jeweler", "珠宝匠利米尔", "entity name")
t("Melnela", "梅涅拉", "entity name")
...
t("A journal.", "一份记录。", "_t")
t("Ring of Lost Love", "逝爱指环", "entity name")
t("pure crimson ring", "纯净的深红色戒指", "_t")
...
t("giant mole hull", "巨大的鼹鼠外壳", "entity name")
...
t("lore", "手札", "entity type")
t("disk", "碟片", "entity subtype")
t("disk", "碟片", "_t")
t([[A strange black disk found in the G.E.M.
You have no idea how to use it.]], [[在G.E.M.找到的奇怪碟片。
你不知道如何使用它]], "_t")
t("erratic scribblings", "潦草的字迹", "entity name")
t("A journal.", "一份记录。", "_t")
t("schematic: Steam Powered Armour", "配方：蒸汽动力装甲", "entity name")
t("flesh", "肉", "entity type")
t("muscle", "肌肉", "entity subtype")
...
t("G.E.M. Exterior", "G.E.M. 外部", "_t")
t("G.E.M. Crew Deck", "G.E.M. 乘员室", "_t")
t("G.E.M. Command Deck", "G.E.M. 控制室", "_t")
-- untranslated text
--[==[
t("G.E.M.", "G.E.M.", "_t")
--]==]
...
t("wooden barricade", "木制路障", "entity name")
t("wall", "墙壁", "entity type")
t("burnt tree", "烧焦的树", "entity name")
t("way to the Vor section", "通向沃尔关押区的路", "entity name")
t("way to the Gorbat section", "通向加伯特关押区的路", "entity name")
t("way to the Grushnak section", "通向格鲁希纳克关押区的路", "entity name")
t("way to the Rak'Shor section", "通向拉克肖关押区的路", "entity name")
t("way back", "返回的路", "entity name")
...
t("I am everywhere, you can't defeat me!", "我无处不在，你无法打败我！", "_t")
t("humanoid", "人形生物", "entity type")
t("halfling", "半身人", "entity subtype")
t("Mindwall", "意念之墙", "entity name")
t("You should be parked with the others!", "你应该和其他人一样被我关起来！", "_t")
t("You have no place in this new world!", "你们在新世界里没有位置！", "_t")
t("Your mind looks delicious...", "你的精神很美味…", "_t")
t("I hunger for more brains...", "我想要更多大脑…", "_t")
t("#YELLOW#Mindwall focuses his thoughts on your mind.  You feel extremely confused.", "#YELLOW#意念之墙用意志干扰你的精神。你陷入了极度混乱之中。", "logPlayer")
t("immovable", "静态类", "entity type")
...
t("Internment Camp", "拘留营", "_t")
t("Internment Camp (Rak'Shor)", "拉克肖部落拘留营", "_t")
t("Internment Camp (Vor)", "沃尔部落拘留营", "_t")
t("Internment Camp (Gorbat)", "加伯特部落拘留营", "_t")
t("Internment Camp (Grushnak)", "格鲁希纳克部落拘留营", "_t")
t("Strange Clearing", "奇怪的空地", "_t")
t("Freedom! Let's rally to Kruk Pride!", "我们自由了！冲向克鲁克部落！", "_t")
t("Mindwall", "意念之墙", "_t")
...
t("Open the chest with Kaltor's key?", "使用卡托尔的钥匙打开宝箱吗？", "_t")
...
t("Kaltor's Shop", "卡托尔的商店", "_t")

------------------------------------------------
section "tome-orcs/data/zones/krimbul/grids.lua"

t("airship hull", "飞艇", "entity name")
t("breach into the airship hull", "通往飞艇内部的缺口", "entity name")
...
t("floor", "地板", "entity type")
t("sand", "沙", "entity subtype")
t("Stair to the ruins", "进入废墟的楼梯", "entity name")
t("Stair to the cave", "进入山洞的楼梯", "entity name")
t("Old Psi-Machine", "古老的灵能机器", "entity name")
...
t("Nothing will ever reach you again.", "任何事物都无法再碰触你。", "_t")
t("You are immune to mental status effects.", "你免疫精神状态效果。", "_t")

------------------------------------------------
section "tome-orcs/data/zones/lost-city/zone.lua"

t("Ruins of a lost city", "失落之城废墟", "_t")
...
t("open mech door", "打开的机械门", "entity name")
t("Phonograph", "留声机", "entity name")
t("throne", "王座", "entity type")
t("throne", "王座", "entity name")
...
t("timeswapped %s", "时空转移的%s", "_t")
t("splitted %s", "分裂的%s", "_t")
t("temporal %s", "时空的%s", "_t")
...
t("wall", "墙壁", "entity type")
t("grass", "草地", "entity subtype")
t("primal tree", "远古树木", "entity name")
t("tall thick primal tree", "高大茂密的远古树木", "entity name")
t("huge primal tree", "参天古树", "entity name")
t("trigger", "按钮", "entity type")
t("trigger", "按钮", "entity subtype")
t("climb", "攀爬", "_t")
t("Huge Tree", "巨大的树", "_t")
t("You think you can climb this tree if you want.", "你可以攀登这棵树。", "_t")
t("Climb", "攀爬", "_t")
t("Stay", "呆在这里", "_t")
t("floor", "地板", "entity type")
t("primal trunk", "原始树木", "entity subtype")
...
t("Ruined Cave", "废弃洞穴", "_t")
t("This cave looks very solid and stable. You can probably leave items here for later.", "这个洞穴看起来非常坚固和稳定。你可以把东西留在这里，以供以后使用。", "_t")
...
But there it is, half alive, half dead but you can feel his thoughts in your head, there is no mistake: #{bold}#The Dead God is here!#{normal}#]], [[你从没想象这样的事情居然会发生，你不相信你居然会遇到它。但是这是真的，在你面前矗立着的就是阿马克泰尔肢体的一部分。
...
t("giant steam valve", "巨大的蒸汽阀门", "entity name")
t("#PURPLE#You kick and destroy the valve!", "#PURPLE#你踢坏了阀门！", "log")

------------------------------------------------
section "tome-orcs/data/zones/steam-quarry/npcs.lua"

t("Automated Defense System", "自动防御系统", "entity name")
t("This heavily armored mecharachnid looks extremely dangerous and well equipped to defend the quarry.", "这个重装的机械蜘蛛看起来极其危险，全副武装，准备保卫采石场。", "_t")

------------------------------------------------
section "tome-orcs/data/zones/steam-quarry/objects.lua"

t("a very old journal", "非常古老的日志", "entity name")
t("A journal.", "一份记录。", "_t")
t("schematic: Stormcutter", "配方：风暴切裂者", "entity name")

------------------------------------------------
section "tome-orcs/data/zones/steam-quarry/zone.lua"

t("Steam Quarry", "蒸汽采石场", "_t")
...
t("void", "虚空", "entity type")
t("void", "虚空", "entity subtype")
t("bottom of the mountain", "山脚", "entity name")
t("floor", "地板", "entity type")
t("rocks", "岩石", "entity subtype")
t("rocks", "岩石", "entity name")
t("way into a strange cave", "通向奇怪山洞的路", "entity name")
t("stairs to the previous level", "通往上一层的楼梯", "entity name")
t("stairs to the cavern", "通往洞穴的楼梯", "entity name")
t("pillar of the sun", "日之柱", "entity name")
t("pillar of the moons", "月之柱", "entity name")
...
t("a journal", "一份记录", "entity name")
t("A journal.", "一份记录。", "_t")
t("Cap of the Undisturbed Mind", "平静思维之帽", "entity name")
t("red cap", "红色的帽子", "_t")
...
t("#CRIMSON#The yeti is not hurt enough to control.", "#CRIMSON#该雪人生命值过高，无法控制。", "logPlayer")
t("#CRIMSON#The yeti is not hurt enough to control.", "#CRIMSON#该雪人生命值过高，无法控制。", "saySimple")
t("#AQUAMARINE#You overtake the yeti's mind and order it to report to Kruk Pride.", "#AQUAMARINE#你控制了雪人的思维，将其送往克鲁克部落。", "logPlayer")
t("#AQUAMARINE#You overtake the yeti's mind and order it to report to Kruk Pride.", "#AQUAMARINE#你控制了雪人的思维，将其送往克鲁克部落。", "saySimple")
...
t("Tinkers Store", "工匠商店", "entity name")
t("Library", "图书馆", "entity name")

------------------------------------------------
section "tome-orcs/data/zones/town-kruk/zone.lua"

t("Kruk Pride", "克鲁克部落", "_t")
...
t("paper scrap", "碎纸片", "entity name")
t("A paper scrap.", "一张碎纸片。", "_t")
t("schematic: Hands of Creation", "配方：创造之手", "entity name")

------------------------------------------------
section "tome-orcs/data/zones/ureslak-host/zone.lua"

t("Ureslak's Host", "乌瑞斯拉克沉睡处", "_t")

------------------------------------------------
section "tome-orcs/data/zones/vaporous-emporium/grids.lua"

t("merchant stall", "货摊", "entity name")
...
t("giant", "巨人", "entity type")
t("steam", "蒸汽", "entity subtype")
t("An unarmed steam giant.", "一个手无寸铁的蒸汽巨人。", "_t")
t("Guards!", "卫兵！", "_t")
t("Help!", "救命！", "_t")
t("steam giant commoner", "蒸汽巨人平民", "entity name")
t("Pockets of gold jingle around the waist of this giant.", "巨人的腰间传来了金币的叮当响。", "_t")
...
t("poster", "海报", "entity name")
t("An advertisement poster.", "一张广告海报。", "_t")

------------------------------------------------
section "tome-orcs/data/zones/vaporous-emporium/zone.lua"

t("Vaporous Emporium", "蒸汽商场", "_t")

------------------------------------------------
section "tome-orcs/data/zones/wilderness-add/grids.lua"

t("bridge to the mainland", "通往大陆的桥梁", "entity name")
t("Kruk Pride (Town)", "克鲁克部落（城镇）", "entity name")
t("The last free Pride of the Orcs", "兽人最后的自由部落", "_t")
t("Entrance to the Yeti Caves", "雪人洞穴入口", "entity name")
t("Entrance to Krimbul territory", "克里布尔领土入口", "entity name")
t("Entrance to the Vaporous Emporium", "蒸汽商场入口", "entity name")
t("Huge door to Kaltor's Shop", "卡托尔商店的大门", "entity name")
t("Entrance to the Sunwall Outpost", "太阳堡垒前哨站入口", "entity name")
...
t("Pain", "痛苦月", "calendar orc")
t("Dearth", "萧条月", "calendar orc")
t("Loss", "亏蚀月", "calendar orc")
t("Destruction", "毁灭月", "calendar orc")
t("Renewal", "复兴日", "calendar orc")
...
t("New birth option: #LIGHT_GREEN#All classes", "新的游戏选项: #LIGHT_GREEN#所有职业", "_t")
...
t("New birth option: #LIGHT_GREEN#Mages", "新的游戏选项: #LIGHT_GREEN#法师系", "_t")
...
t("New birth option: #LIGHT_GREEN#Rogues", "新的游戏选项: #LIGHT_GREEN#盗贼系", "_t")
t([[You have freed the Prides from the Internment Camp.
...
t("New Age of Ascendancy birth option: #LIGHT_GREEN#Tinkers", "新的原版战役选项: #LIGHT_GREEN#工匠系", "_t")
...
t("New Talent Category: #LIGHT_GREEN#Undead Drake", "新的技能树：#LIGHT_GREEN#亡灵龙系", "_t")
...
t("Tier 4", "材质等级 4", "_t")
t("Tier 5", "材质等级 5", "_t")
t("Requires talents:", "需要技能：", "_t")
t("Requires ingredients:", "需要原材料：", "_t")
t(" (You have: %s)", " (你有: %s)", "tformat")
t("Requires items:", "需要物品：", "_t")
t("Requires:", "装备需求：", "_t")
t("Example Item:", "样品：", "_t")
t("body", "躯体", "_t")
t("create tier( %s )", "材质等级(%s)", "tformat")
t("missing reqs", "条件不足", "_t")
-- untranslated text
--[==[
t("", "", "_t")
--]==]
...
t("#PURPLE#Automated Reflex System activated!", "#PURPLE#自动化反射系统启动！", "saySimple")
t("#PURPLE#Automated Reflex System activated!", "#PURPLE#自动化反射系统启动！", "log")
...
蒸汽是由特殊的发动机产生的，用来为大多数科技产品提供动力。
增加最大蒸汽容量是非常困难的，但它再生很快。
要么使用它，要么很快失去它。
]], "_t")
...
你的蒸汽强度表现了你的蒸汽科技能力有多强力。
这和物理强度机制类似，但是蒸汽强度随灵巧值提升。
]], "_t")
...
t("Welcome to #CRIMSON#Embers of Rage", "欢迎来到#CRIMSON#余烬怒火", "_t")
