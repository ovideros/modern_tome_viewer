...
newTalent{
	...
	target = function(self, t) return {type="cone", talent=t, cone_angle = 45, range=0, radius=self:getTalentRange(t), selffire=false, friendlyfire=false} end,
	action = function(self, t)
		local tg = self:getTalentTarget(t)
		local x, y = self:getTarget(tg)
	...
	info = function(self, t)
		return ([[Your face melts, exploding in a targeted gush of blood and gore dealing %0.2f darkness damage (%0.2f total) in a cone over 5 turns.
		Each turn the target will be dealt an additional %0.2f blight damage per disease.
		Damage will increase with your Spellpower.]])
		:tformat(damDesc(self, DamageType.DARKNESS, t.getDamage(self, t) / 5), damDesc(self, DamageType.DARKNESS, t.getDamage(self, t)), damDesc(self, DamageType.BLIGHT, 0.7 * t.getDamage(self, t) / 5))
	end,
}
...
newTalent{
	...
	info = function(self, t)
		...
		tformat(t.getSpeed(self, t) * 100, t.getBrittle(self, t))
	end,
}
...
newTalent{
	...
	info = function(self, t)
		...
		tformat(t.getFail(self, t), t.getPen(self, t))
	end,
}
