...
load("/data-cults/general/grids/maggot.lua")

newEntity{
	define_as = "MAGGOT_PORTAL",
	type = "floor", subtype = "maggot",
	name = "portal to Kroshkkur", image = "terrain/maggot/maggot_floor_1_01.png", add_mos={{image = "terrain/demon_portal.png"}},
	display = '<', color_r=255, color_g=0, color_b=255,
	always_remember = true,
	notice = true,
	shader = "maggot",
	change_level = 1,
	change_zone = "cults+town-kroshkkur",
}

newEntity{
	define_as = "MAGGOT_SPINE",
	type = "floor", subtype = "maggot", is_maggot_spine = true,
	name = "maggot's nerval spine", image = "terrain/maggot/maggot_floor_1_01.png",
...
for i = 1, 5 do
	newEntity{ base = "MAGGOT_SPINE", define_as = "MAGGOT_SPINE_HORIZ"..i,
		add_mos = {{image="terrain/spinal_cord/spinal_cord_horizontal_top_a_0"..i..".png"}},
	}
end
newEntity{ base = "MAGGOT_SPINE", define_as = "MAGGOT_SPINE_DIAG_START_3",
...
newEntity{ base = "MAGGOT_SPINE", define_as = "MAGGOT_SPINE_DIAG_START_9",
...
for i = 1, 2 do
	newEntity{ base = "MAGGOT_SPINE", define_as = "MAGGOT_SPINE_DIAG_3_"..i,
		add_mos = {{image="terrain/spinal_cord/spinal_cord_diagonal_line_b_0"..i..".png"}},
		add_displays = {class.new{image="terrain/spinal_cord/spinal_cord_diagonal_line_tiny_d_02.png", display_y=1, z=2, add_mos={{image="terrain/spinal_cord/spinal_cord_diagonal_line_tiny_c_01.png", display_x=1}}}},
	}
	newEntity{ base = "MAGGOT_SPINE", define_as = "MAGGOT_SPINE_DIAG_9_"..i,
		add_mos = {{image="terrain/spinal_cord/spinal_cord_diagonal_line_a_0"..i..".png"}},
		add_displays = {class.new{image="terrain/spinal_cord/spinal_cord_diagonal_line_tiny_a_02.png", display_y=-1, z=2, add_mos={{image="terrain/spinal_cord/spinal_cord_diagonal_line_tiny_e_01.png", display_x=1}}}},
	}
end
newEntity{ base = "MAGGOT_SPINE", define_as = "MAGGOT_SPINE_DIAG_STOP_3",
	add_mos = {{image="terrain/spinal_cord/spinal_cord_diagonal_start_a_07.png"}},
}
newEntity{ base = "MAGGOT_SPINE", define_as = "MAGGOT_SPINE_DIAG_STOP_9",
	add_mos = {{image="terrain/spinal_cord/spinal_cord_diagonal_start_a_02.png"}},
}
newEntity{ base = "MAGGOT_SPINE", define_as = "MAGGOT_SPINE_START",
...
for _, e in ipairs(loading_list) do if e.is_maggot_spine then
	...
	ne.name = ("%s (dead)"):tformat(_t(ne.name))
...
newEntity{ base = "MAGGOT_SPINE", define_as = "DEAD_MAGGOT_SPINE_HEAD",
