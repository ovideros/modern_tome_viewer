...
local cave_wall_editer = { method="kroshkkurCaveWalls_def", def="kroshkkurcavewall"}
local cave_floor_editer = { method="borders_def", def="kroshkkurcavefloor"}
...
newEntity{
	...
	nice_editer2 = cave_floor_editer,
