...
function _M:init(actor)
	...
	Dialog.init(self, _t"Revelation", game.w * 0.6, game.h * 0.8)
...
function _M:generateList()
	...
	list = {
		{ char='', name=(_t'#{bold}#Choose a talent#{normal}#'):toTString(), status='', hotkey='', desc=_t"All prophecies that can be used with Revelation.", color=function() return colors.simple(colors.LIGHT_GREEN) end, nodes=talents, shown=true },
		chars = chars,
	}
	self.list = list
end
